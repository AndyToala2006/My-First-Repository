...
def mostrar_codigo(ruta_script):
    """
    Muestra el código de un script dado su ruta.
    """
...
def ejecutar_codigo(ruta_script):
    """
    Ejecuta un script Python en función del sistema operativo.
    """
    try:
...
def mostrar_menu():
    """
    Muestra el menú principal para navegar entre las unidades y sus contenidos.
    """
    # Define la ruta base donde se encuentra el dashboard.py
    ruta_base = os.path.dirname(__file__)

    # Unidades y sus rutas asociadas
    unidades = {
        ...
        '3': 'Unidad 3/3.1. Algoritmos/3.1-1. Ejemplo Algoritmos.py',
        # Agrega aquí el resto de las rutas de las unidades
    }
...
def mostrar_sub_menu(ruta_unidad):
    """
    Muestra un submenú con las carpetas de una unidad específica.
    """
...
def mostrar_scripts(ruta_sub_carpeta):
    """
    Muestra los scripts dentro de una subcarpeta específica y permite al usuario ejecutar uno.
    """
